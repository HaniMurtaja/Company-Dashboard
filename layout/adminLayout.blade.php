    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <!--<div class="page-sidebar navbar-collapse collapse">
                ...
                @if(can('students'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "students") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/students')}}" class="nav-link nav-toggle">
                            <i class="fa fa-user"></i>
                            <span class="title">{{__('cp.students')}}</span>
                ...
                @if(can('teachers'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "teachers") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/teachers')}}" class="nav-link nav-toggle">
                            <i class="fa fa-book"></i>
                            <span class="title">{{__('cp.teachers')}}</span>
                        </a>
                    </li>
                @endif

                @if(can('upgradeRequests'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "upgradeRequests") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/upgradeRequests')}}" class="nav-link nav-toggle">
                            <i class="fa fa-book"></i>
                            <span class="title">{{__('cp.upgradeRequests')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(can('universities'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "universities") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/universities')}}" class="nav-link nav-toggle">
                            <i class="fa fa-book"></i>
                            <span class="title">{{__('cp.universities')}}</span>
                        </a>
                    </li>
                @endif

                @if(can('specialists'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "specialists") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/specialists')}}" class="nav-link nav-toggle">
                            <i class="fa fa-book"></i>
                            <span class="title">{{__('cp.specialists')}}</span>
                        </a>
                    </li>
                @endif

                @if(can('subjects'))
                    <li class="nav-item {{(explode("/", request()->url())[5] == "subjects") ? "active open" : ''}} ">
                        <a href="{{url(getLocal().'/admin/subjects')}}" class="nav-link nav-toggle">
                            <i class="fa fa-book"></i>
                            <span class="title">{{__('cp.subjects')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @endif
                     ...
                     @if(can('rates'))
                    <li class="nav-item  {{(explode("/", request()->url())[5] == "rates") ? "active open" : ''}}">
                        <a href="{{url(getLocal().'/admin/rates')}}" class="nav-link nav-toggle">
                            <i class="fa fa-star"></i>
                            <span class="title">{{__('cp.rate')}}</span>
                        </a>
                    </li>
                    @endif
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                <li>
                    <a href="{{url('/admin/home')}}">{{__('common.statistics')}}</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>{{__('common.confirmDeleteAll')}} </p>
            </div>
            <div class="modal-footer">
                <button class="btn default" data-dismiss="modal" aria-hidden="true" >{{__('common.cancel')}}</button>
                <a href="#" class="confirmAll" data-action="delete"><button class="btn btn-danger">{{__('common.delete')}}</button></a>
            </div>
        </div>
    </div>
</div>
...
<div id="activation" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">{{__('common.activation')}}</h4>
            </div>
            <div class="modal-body">
                <p>{{__('common.confirmActiveAll')}} </p>
            </div>
            <div class="modal-footer">
                <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                <a href="#" class="confirmAll" data-action="active">
                    <button class="btn btn-success">{{__('common.Yes')}}</button>
                </a>
            </div>
        </div>
    </div>
...
<div id="cancel_activation" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">{{__('common.cancel_activation')}}</h4>
            </div>
            <div class="modal-body">
                <p>{{__('common.confirmNotActiveAll')}} </p>
            </div>
            <div class="modal-footer">
                <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                <a href="#" class="confirmAll" data-action="not_active"><button class="btn btn-default">{{__('common.Yes')}}</button></a>
            </div>
        </div>
    </div>
</div>
